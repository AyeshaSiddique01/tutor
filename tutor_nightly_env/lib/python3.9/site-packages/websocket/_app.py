...
class Dispatcher(DispatcherBase):
    ...
    def read(
        self, sock: socket.socket, read_callback: Callable, check_callback: Callable
    ) -> None:
...
class WebSocketApp:
    ...
    def create_dispatcher(
        self, ping_timeout: int, dispatcher: Dispatcher = None, is_ssl: bool = False
    ) -> DispatcherBase:

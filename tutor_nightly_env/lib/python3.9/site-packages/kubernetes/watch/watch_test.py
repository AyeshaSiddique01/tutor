...
class WatchTests(unittest.TestCase):
    ...
    def test_watch_with_decode(self):
        ...
        fake_resp.stream.assert_called_once_with(amt=None, decode_content=False)
    ...
    def test_watch_resource_version_set(self):
        ...
        fake_resp.stream = Mock(side_effect=get_values)
    ...
    def test_watch_stream_loop(self):
        ...
        fake_resp.close = Mock()
        fake_resp.release_conn = Mock()
        fake_resp.stream = Mock(return_value=['{"type": "ADDED", "object": 1}\n'])
    ...
    def test_watch_retries_on_error_event(self):
        ...
        fake_resp.stream.assert_has_calls([call(amt=None, decode_content=False)] * 2)

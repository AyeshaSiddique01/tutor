...
class TestDynamicClient(unittest.TestCase):
    ...
    def test_async_namespaced_custom_resources(self):
        ...
        async_resp = crd_api.get(name=name, async_req=True)
        self.assertEqual(name, async_resp.metadata.name)
        self.assertTrue(async_resp.status)
        ...
        async_resp = changeme_api.create(
            body=changeme_manifest, namespace="default", async_req=True
        )
        self.assertEqual(async_resp.metadata.name, changeme_name)

        async_resp = changeme_api.get(
            name=changeme_name, namespace="default", async_req=True
        )
        self.assertEqual(async_resp.metadata.name, changeme_name)
        ...
        async_resp = crd_api.delete(name=name, async_req=True)
    ...
    def test_namespaced_custom_resources(self):
        ...
        resp = changeme_api.delete(name=changeme_name, namespace="default")
    ...
    def test_service_apis(self):
        ...
        resp = api.create(body=service_manifest, namespace="default")
        self.assertEqual(name, resp.metadata.name)
        self.assertTrue(resp.status)
        ...
        resp = api.patch(body=service_manifest, name=name, namespace="default")
    ...
    def test_replication_controller_apis(self):
        ...
        resp = api.create(body=rc_manifest, namespace="default")
        self.assertEqual(name, resp.metadata.name)
        ...
        api.delete(name=name, namespace="default", propagation_policy="Background")
    ...
    def test_configmap_apis(self):
        ...
        resp = api.get(name=name, namespace="default", label_selector="e2e-test=true")
        self.assertEqual(name, resp.metadata.name)
...
class TestDynamicClientSerialization(unittest.TestCase):
    ...
    def test_dict_type(self):
        self.assertEqual(
            self.client.serialize_body(self.pod_manifest), self.pod_manifest
        )

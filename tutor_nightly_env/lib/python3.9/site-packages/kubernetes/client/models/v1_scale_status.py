...
class V1ScaleStatus(object):
    ...
    def __init__(
        self, replicas=None, selector=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def replicas(self, replicas):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and replicas is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `replicas`, must not be `None`"
            )  # noqa: E501

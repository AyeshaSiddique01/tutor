...
class V1TokenRequestStatus(object):
    ...
    """
    openapi_types = {"expiration_timestamp": "datetime", "token": "str"}

    attribute_map = {"expiration_timestamp": "expirationTimestamp", "token": "token"}

    def __init__(
        self, expiration_timestamp=None, token=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def expiration_timestamp(self, expiration_timestamp):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `expiration_timestamp`, must not be `None`"
            )  # noqa: E501

...
class V2ContainerResourceMetricSource(object):
    ...
    """
    openapi_types = {"container": "str", "name": "str", "target": "V2MetricTarget"}

    attribute_map = {"container": "container", "name": "name", "target": "target"}

    def __init__(
        self, container=None, name=None, target=None, local_vars_configuration=None
    ):  # noqa: E501

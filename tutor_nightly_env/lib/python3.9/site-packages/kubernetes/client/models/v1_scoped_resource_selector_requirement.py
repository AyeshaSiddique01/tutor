...
class V1ScopedResourceSelectorRequirement(object):
    ...
    def __init__(
        self, operator=None, scope_name=None, values=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def scope_name(self, scope_name):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and scope_name is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `scope_name`, must not be `None`"
            )  # noqa: E501

...
class V1ServerAddressByClientCIDR(object):
    ...
    def __init__(
        self, client_cidr=None, server_address=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def client_cidr(self, client_cidr):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and client_cidr is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `client_cidr`, must not be `None`"
            )  # noqa: E501
    ...
    def server_address(self, server_address):
        ...
        if (
            ...
            and server_address is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `server_address`, must not be `None`"
            )  # noqa: E501

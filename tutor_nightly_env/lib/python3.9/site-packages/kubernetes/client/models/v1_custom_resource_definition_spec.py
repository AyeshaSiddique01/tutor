...
class V1CustomResourceDefinitionSpec(object):
    ...
    def group(self, group):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and group is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def names(self, names):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and names is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def versions(self, versions):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and versions is None
        ):  # noqa: E501
            raise ValueError(

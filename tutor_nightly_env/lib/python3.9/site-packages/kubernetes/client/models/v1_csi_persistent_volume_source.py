...
class V1CSIPersistentVolumeSource(object):
    ...
    def driver(self, driver):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and driver is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `driver`, must not be `None`"
            )  # noqa: E501
    ...
    def volume_handle(self, volume_handle):
        ...
        if (
            ...
            and volume_handle is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `volume_handle`, must not be `None`"
            )  # noqa: E501

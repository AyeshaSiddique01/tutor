...
class V1NodeSystemInfo(object):
    ...
    def boot_id(self, boot_id):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and boot_id is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `boot_id`, must not be `None`"
            )  # noqa: E501
    ...
    def kube_proxy_version(self, kube_proxy_version):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and kube_proxy_version is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def os_image(self, os_image):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and os_image is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `os_image`, must not be `None`"
            )  # noqa: E501
    ...
    def system_uuid(self, system_uuid):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `system_uuid`, must not be `None`"
            )  # noqa: E501

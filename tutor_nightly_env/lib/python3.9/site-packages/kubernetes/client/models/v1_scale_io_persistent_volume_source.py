...
class V1ScaleIOPersistentVolumeSource(object):
    ...
    def gateway(self, gateway):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and gateway is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `gateway`, must not be `None`"
            )  # noqa: E501
    ...
    def secret_ref(self, secret_ref):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and secret_ref is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `secret_ref`, must not be `None`"
            )  # noqa: E501
    ...
    def system(self, system):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and system is None
        ):  # noqa: E501
            raise ValueError(

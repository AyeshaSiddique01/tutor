...
class V1WeightedPodAffinityTerm(object):
    ...
    """
    openapi_types = {"pod_affinity_term": "V1PodAffinityTerm", "weight": "int"}

    attribute_map = {"pod_affinity_term": "podAffinityTerm", "weight": "weight"}

    def __init__(
        self, pod_affinity_term=None, weight=None, local_vars_configuration=None
    ):  # noqa: E501

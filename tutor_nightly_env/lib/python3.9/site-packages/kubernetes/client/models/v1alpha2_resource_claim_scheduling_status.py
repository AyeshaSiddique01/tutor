...
class V1alpha2ResourceClaimSchedulingStatus(object):
    ...
    """
    openapi_types = {"name": "str", "unsuitable_nodes": "list[str]"}

    attribute_map = {"name": "name", "unsuitable_nodes": "unsuitableNodes"}

    def __init__(
        self, name=None, unsuitable_nodes=None, local_vars_configuration=None
    ):  # noqa: E501

...
class V1alpha1ExpressionWarning(object):
    ...
    def __init__(
        self, field_ref=None, warning=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def field_ref(self, field_ref):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and field_ref is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `field_ref`, must not be `None`"
            )  # noqa: E501
    ...
    def warning(self, warning):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and warning is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `warning`, must not be `None`"
            )  # noqa: E501

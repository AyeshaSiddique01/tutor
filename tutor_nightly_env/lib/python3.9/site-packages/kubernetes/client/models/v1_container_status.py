...
class V1ContainerStatus(object):
    ...
    def ready(self, ready):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and ready is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `ready`, must not be `None`"
            )  # noqa: E501
    ...
    def restart_count(self, restart_count):
        ...
        if (
            ...
            and restart_count is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `restart_count`, must not be `None`"
            )  # noqa: E501

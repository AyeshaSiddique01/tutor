...
class V1PodDisruptionBudgetStatus(object):
    ...
    def disruptions_allowed(self, disruptions_allowed):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and disruptions_allowed is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def expected_pods(self, expected_pods):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and expected_pods is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `expected_pods`, must not be `None`"
            )  # noqa: E501

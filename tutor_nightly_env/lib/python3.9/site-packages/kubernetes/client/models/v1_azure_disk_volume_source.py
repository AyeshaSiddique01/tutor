...
class V1AzureDiskVolumeSource(object):
    ...
    def disk_name(self, disk_name):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and disk_name is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `disk_name`, must not be `None`"
            )  # noqa: E501
    ...
    def disk_uri(self, disk_uri):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and disk_uri is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `disk_uri`, must not be `None`"
            )  # noqa: E501

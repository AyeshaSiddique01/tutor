...
class V1VolumeAttachmentSpec(object):
    ...
    def __init__(
        self, attacher=None, node_name=None, source=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def attacher(self, attacher):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and attacher is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `attacher`, must not be `None`"
            )  # noqa: E501
    ...
    def node_name(self, node_name):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and node_name is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `node_name`, must not be `None`"
            )  # noqa: E501

...
class V1HTTPIngressPath(object):
    ...
    def backend(self, backend):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and backend is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `backend`, must not be `None`"
            )  # noqa: E501
    ...
    def path_type(self, path_type):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and path_type is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `path_type`, must not be `None`"
            )  # noqa: E501

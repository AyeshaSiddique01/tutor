...
class VersionInfo(object):
    ...
    def build_date(self, build_date):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and build_date is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def compiler(self, compiler):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and compiler is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `compiler`, must not be `None`"
            )  # noqa: E501
    ...
    def git_commit(self, git_commit):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and git_commit is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `git_commit`, must not be `None`"
            )  # noqa: E501
    ...
    def git_tree_state(self, git_tree_state):
        ...
        if (
            ...
            and git_tree_state is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `git_tree_state`, must not be `None`"
            )  # noqa: E501
    ...
    def git_version(self, git_version):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and git_version is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `git_version`, must not be `None`"
            )  # noqa: E501

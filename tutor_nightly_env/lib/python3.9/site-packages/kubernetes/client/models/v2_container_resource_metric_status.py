...
class V2ContainerResourceMetricStatus(object):
    ...
    attribute_map = {"container": "container", "current": "current", "name": "name"}

    def __init__(
        self, container=None, current=None, name=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def current(self, current):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and current is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `current`, must not be `None`"
            )  # noqa: E501

...
class V1ISCSIVolumeSource(object):
    ...
    def iqn(self, iqn):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and iqn is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `iqn`, must not be `None`"
            )  # noqa: E501
    ...
    def lun(self, lun):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and lun is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `lun`, must not be `None`"
            )  # noqa: E501
    ...
    def target_portal(self, target_portal):
        ...
        if (
            ...
            and target_portal is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `target_portal`, must not be `None`"
            )  # noqa: E501

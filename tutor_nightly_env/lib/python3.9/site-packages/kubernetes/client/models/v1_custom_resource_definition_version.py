...
class V1CustomResourceDefinitionVersion(object):
    ...
    def served(self, served):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and served is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `served`, must not be `None`"
            )  # noqa: E501
    ...
    def storage(self, storage):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and storage is None
        ):  # noqa: E501
            raise ValueError(

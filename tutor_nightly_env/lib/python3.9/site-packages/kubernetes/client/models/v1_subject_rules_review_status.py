...
class V1SubjectRulesReviewStatus(object):
    ...
    def incomplete(self, incomplete):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and incomplete is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `incomplete`, must not be `None`"
            )  # noqa: E501
    ...
    def non_resource_rules(self, non_resource_rules):
        ...
        if (
            ...
            and non_resource_rules is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def resource_rules(self, resource_rules):
        ...
        if (
            self.local_vars_configuration.client_side_validation
            and resource_rules is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `resource_rules`, must not be `None`"
            )  # noqa: E501

...
class V1alpha2PodSchedulingContextStatus(object):
    ...
    """
    openapi_types = {"resource_claims": "list[V1alpha2ResourceClaimSchedulingStatus]"}

    attribute_map = {"resource_claims": "resourceClaims"}

    def __init__(
        self, resource_claims=None, local_vars_configuration=None
    ):  # noqa: E501

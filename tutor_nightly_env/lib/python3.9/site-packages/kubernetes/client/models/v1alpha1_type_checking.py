...
class V1alpha1TypeChecking(object):
    ...
    """
    openapi_types = {"expression_warnings": "list[V1alpha1ExpressionWarning]"}

    attribute_map = {"expression_warnings": "expressionWarnings"}

    def __init__(
        self, expression_warnings=None, local_vars_configuration=None
    ):  # noqa: E501

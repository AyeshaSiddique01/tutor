...
class V1CustomResourceConversion(object):
    ...
    def __init__(
        self, strategy=None, webhook=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def strategy(self, strategy):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and strategy is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `strategy`, must not be `None`"
            )  # noqa: E501

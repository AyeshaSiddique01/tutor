...
class V1beta2ResourcePolicyRule(object):
    ...
    def api_groups(self, api_groups):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and api_groups is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `api_groups`, must not be `None`"
            )  # noqa: E501
    ...
    def resources(self, resources):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and resources is None
        ):  # noqa: E501
            raise ValueError(
    ...
    def verbs(self, verbs):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and verbs is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `verbs`, must not be `None`"
            )  # noqa: E501

...
class V1PhotonPersistentDiskVolumeSource(object):
    ...
    def __init__(
        self, fs_type=None, pd_id=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def pd_id(self, pd_id):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and pd_id is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `pd_id`, must not be `None`"
            )  # noqa: E501
